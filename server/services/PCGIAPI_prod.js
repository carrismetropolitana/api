...
const { PCGI_AUTH_URL_PROD, PCGI_CLIENT_ID_PROD, PCGI_CLIENT_SECRET_PROD, PCGI_BASE_URL_PROD } = process.env;
...
class PCGIAPI {
  ...
  async authenticate() {
    try {
      ...
      const response = await fetch(PCGI_AUTH_URL_PROD, {
        method: 'POST',
        headers: { 'content-type': 'application/x-www-form-urlencoded' },
        body: new URLSearchParams({
          client_id: PCGI_CLIENT_ID_PROD,
          client_secret: PCGI_CLIENT_SECRET_PROD,
