...
$root.transit_realtime = (function () {
  ...
  transit_realtime.FeedMessage = (function () {
    ...
    FeedMessage.encode = function encode(message, writer) {
      ...
      if (message.entity != null && message.entity.length) for (var i = 0; i < message.entity.length; ++i) $root.transit_realtime.FeedEntity.encode(message.entity[i], writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
      return writer;
    };
    ...
    FeedMessage.fromObject = function fromObject(object) {
      ...
      if (object.header != null) {
        if (typeof object.header !== 'object') throw TypeError('.transit_realtime.FeedMessage.header: object expected');
      ...
      if (object.entity) {
        ...
        for (var i = 0; i < object.entity.length; ++i) {
          if (typeof object.entity[i] !== 'object') throw TypeError('.transit_realtime.FeedMessage.entity: object expected');
    ...
    FeedMessage.toObject = function toObject(message, options) {
      ...
      if (message.entity && message.entity.length) {
        object.entity = [];
        for (var j = 0; j < message.entity.length; ++j) object.entity[j] = $root.transit_realtime.FeedEntity.toObject(message.entity[j], options);
      }
      return object;
    };
  ...
  transit_realtime.FeedHeader = (function () {
    ...
    FeedHeader.encode = function encode(message, writer) {
      ...
      if (message.incrementality != null && Object.hasOwnProperty.call(message, 'incrementality')) writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.incrementality);
      if (message.timestamp != null && Object.hasOwnProperty.call(message, 'timestamp')) writer.uint32(/* id 3, wireType 0 =*/ 24).uint64(message.timestamp);
      return writer;
    };
    ...
    FeedHeader.fromObject = function fromObject(object) {
      ...
      if (object.timestamp != null)
        ...
        else if (typeof object.timestamp === 'object') message.timestamp = new $util.LongBits(object.timestamp.low >>> 0, object.timestamp.high >>> 0).toNumber(true);
      return message;
    };
      ...
      if (message.incrementality != null && message.hasOwnProperty('incrementality'))
        object.incrementality =
          options.enums === String
            ...
            : message.incrementality;
      if (message.timestamp != null && message.hasOwnProperty('timestamp'))
        if (typeof message.timestamp === 'number') object.timestamp = options.longs === String ? String(message.timestamp) : message.timestamp;
        else
          object.timestamp =
            options.longs === String ? $util.Long.prototype.toString.call(message.timestamp) : options.longs === Number ? new $util.LongBits(message.timestamp.low >>> 0, message.timestamp.high >>> 0).toNumber(true) : message.timestamp;
      return object;
    };
  ...
  transit_realtime.FeedEntity = (function () {
    ...
    FeedEntity.encode = function encode(message, writer) {
      ...
      if (message.isDeleted != null && Object.hasOwnProperty.call(message, 'isDeleted')) writer.uint32(/* id 2, wireType 0 =*/ 16).bool(message.isDeleted);
      if (message.tripUpdate != null && Object.hasOwnProperty.call(message, 'tripUpdate')) $root.transit_realtime.TripUpdate.encode(message.tripUpdate, writer.uint32(/* id 3, wireType 2 =*/ 26).fork()).ldelim();
      if (message.vehicle != null && Object.hasOwnProperty.call(message, 'vehicle')) $root.transit_realtime.VehiclePosition.encode(message.vehicle, writer.uint32(/* id 4, wireType 2 =*/ 34).fork()).ldelim();
      if (message.alert != null && Object.hasOwnProperty.call(message, 'alert')) $root.transit_realtime.Alert.encode(message.alert, writer.uint32(/* id 5, wireType 2 =*/ 42).fork()).ldelim();
      if (message.shape != null && Object.hasOwnProperty.call(message, 'shape')) $root.transit_realtime.Shape.encode(message.shape, writer.uint32(/* id 6, wireType 2 =*/ 50).fork()).ldelim();
      return writer;
    };
    ...
    FeedEntity.fromObject = function fromObject(object) {
      ...
      if (object.tripUpdate != null) {
        if (typeof object.tripUpdate !== 'object') throw TypeError('.transit_realtime.FeedEntity.tripUpdate: object expected');
        message.tripUpdate = $root.transit_realtime.TripUpdate.fromObject(object.tripUpdate);
      }
      if (object.vehicle != null) {
        if (typeof object.vehicle !== 'object') throw TypeError('.transit_realtime.FeedEntity.vehicle: object expected');
        message.vehicle = $root.transit_realtime.VehiclePosition.fromObject(object.vehicle);
      }
      if (object.alert != null) {
        if (typeof object.alert !== 'object') throw TypeError('.transit_realtime.FeedEntity.alert: object expected');
        message.alert = $root.transit_realtime.Alert.fromObject(object.alert);
      }
      if (object.shape != null) {
        if (typeof object.shape !== 'object') throw TypeError('.transit_realtime.FeedEntity.shape: object expected');
    ...
    FeedEntity.toObject = function toObject(message, options) {
      ...
      if (message.shape != null && message.hasOwnProperty('shape')) object.shape = $root.transit_realtime.Shape.toObject(message.shape, options);
      return object;
    };
  ...
  transit_realtime.TripUpdate = (function () {
    ...
    TripUpdate.encode = function encode(message, writer) {
      ...
      if (message.stopTimeUpdate != null && message.stopTimeUpdate.length)
        for (var i = 0; i < message.stopTimeUpdate.length; ++i) $root.transit_realtime.TripUpdate.StopTimeUpdate.encode(message.stopTimeUpdate[i], writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
      if (message.vehicle != null && Object.hasOwnProperty.call(message, 'vehicle')) $root.transit_realtime.VehicleDescriptor.encode(message.vehicle, writer.uint32(/* id 3, wireType 2 =*/ 26).fork()).ldelim();
      if (message.timestamp != null && Object.hasOwnProperty.call(message, 'timestamp')) writer.uint32(/* id 4, wireType 0 =*/ 32).uint64(message.timestamp);
      if (message.delay != null && Object.hasOwnProperty.call(message, 'delay')) writer.uint32(/* id 5, wireType 0 =*/ 40).int32(message.delay);
      if (message.tripProperties != null && Object.hasOwnProperty.call(message, 'tripProperties')) $root.transit_realtime.TripUpdate.TripProperties.encode(message.tripProperties, writer.uint32(/* id 6, wireType 2 =*/ 50).fork()).ldelim();
      return writer;
    };
    ...
    TripUpdate.fromObject = function fromObject(object) {
      ...
      if (object.trip != null) {
        if (typeof object.trip !== 'object') throw TypeError('.transit_realtime.TripUpdate.trip: object expected');
        message.trip = $root.transit_realtime.TripDescriptor.fromObject(object.trip);
      }
      if (object.vehicle != null) {
        if (typeof object.vehicle !== 'object') throw TypeError('.transit_realtime.TripUpdate.vehicle: object expected');
      ...
      if (object.stopTimeUpdate) {
        ...
        for (var i = 0; i < object.stopTimeUpdate.length; ++i) {
          if (typeof object.stopTimeUpdate[i] !== 'object') throw TypeError('.transit_realtime.TripUpdate.stopTimeUpdate: object expected');
      ...
      if (object.tripProperties != null) {
        if (typeof object.tripProperties !== 'object') throw TypeError('.transit_realtime.TripUpdate.tripProperties: object expected');
    ...
    TripUpdate.toObject = function toObject(message, options) {
      ...
      if (message.stopTimeUpdate && message.stopTimeUpdate.length) {
        ...
        for (var j = 0; j < message.stopTimeUpdate.length; ++j) object.stopTimeUpdate[j] = $root.transit_realtime.TripUpdate.StopTimeUpdate.toObject(message.stopTimeUpdate[j], options);
      }
      ...
      if (message.tripProperties != null && message.hasOwnProperty('tripProperties')) object.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.toObject(message.tripProperties, options);
      return object;
    };
    ...
    TripUpdate.StopTimeEvent = (function () {
      ...
      StopTimeEvent.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.delay != null && Object.hasOwnProperty.call(message, 'delay')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.delay);
        if (message.time != null && Object.hasOwnProperty.call(message, 'time')) writer.uint32(/* id 2, wireType 0 =*/ 16).int64(message.time);
        if (message.uncertainty != null && Object.hasOwnProperty.call(message, 'uncertainty')) writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.uncertainty);
        return writer;
      };
      ...
      StopTimeEvent.fromObject = function fromObject(object) {
        ...
        if (object.time != null)
          ...
          else if (typeof object.time === 'object') message.time = new $util.LongBits(object.time.low >>> 0, object.time.high >>> 0).toNumber();
      ...
      StopTimeEvent.toObject = function toObject(message, options) {
        ...
        if (message.time != null && message.hasOwnProperty('time'))
          ...
          else object.time = options.longs === String ? $util.Long.prototype.toString.call(message.time) : options.longs === Number ? new $util.LongBits(message.time.low >>> 0, message.time.high >>> 0).toNumber() : message.time;
    ...
    TripUpdate.StopTimeUpdate = (function () {
      ...
      StopTimeUpdate.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.stopSequence != null && Object.hasOwnProperty.call(message, 'stopSequence')) writer.uint32(/* id 1, wireType 0 =*/ 8).uint32(message.stopSequence);
        if (message.arrival != null && Object.hasOwnProperty.call(message, 'arrival')) $root.transit_realtime.TripUpdate.StopTimeEvent.encode(message.arrival, writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
        if (message.departure != null && Object.hasOwnProperty.call(message, 'departure')) $root.transit_realtime.TripUpdate.StopTimeEvent.encode(message.departure, writer.uint32(/* id 3, wireType 2 =*/ 26).fork()).ldelim();
        if (message.stopId != null && Object.hasOwnProperty.call(message, 'stopId')) writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.stopId);
        if (message.scheduleRelationship != null && Object.hasOwnProperty.call(message, 'scheduleRelationship')) writer.uint32(/* id 5, wireType 0 =*/ 40).int32(message.scheduleRelationship);
        ...
        if (message.departureOccupancyStatus != null && Object.hasOwnProperty.call(message, 'departureOccupancyStatus')) writer.uint32(/* id 7, wireType 0 =*/ 56).int32(message.departureOccupancyStatus);
        return writer;
      };
      ...
      StopTimeUpdate.fromObject = function fromObject(object) {
        ...
        if (object.arrival != null) {
          if (typeof object.arrival !== 'object') throw TypeError('.transit_realtime.TripUpdate.StopTimeUpdate.arrival: object expected');
          message.arrival = $root.transit_realtime.TripUpdate.StopTimeEvent.fromObject(object.arrival);
        }
        if (object.departure != null) {
          if (typeof object.departure !== 'object') throw TypeError('.transit_realtime.TripUpdate.StopTimeUpdate.departure: object expected');
        ...
        if (object.stopTimeProperties != null) {
          if (typeof object.stopTimeProperties !== 'object') throw TypeError('.transit_realtime.TripUpdate.StopTimeUpdate.stopTimeProperties: object expected');
      ...
      StopTimeUpdate.toObject = function toObject(message, options) {
        ...
        if (message.scheduleRelationship != null && message.hasOwnProperty('scheduleRelationship'))
          object.scheduleRelationship =
            options.enums === String
              ? $root.transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship[message.scheduleRelationship] === undefined
                ? message.scheduleRelationship
                : $root.transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship[message.scheduleRelationship]
              : message.scheduleRelationship;
        if (message.stopTimeProperties != null && message.hasOwnProperty('stopTimeProperties')) object.stopTimeProperties = $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.toObject(message.stopTimeProperties, options);
        if (message.departureOccupancyStatus != null && message.hasOwnProperty('departureOccupancyStatus'))
          object.departureOccupancyStatus =
            options.enums === String
              ? $root.transit_realtime.VehiclePosition.OccupancyStatus[message.departureOccupancyStatus] === undefined
                ? message.departureOccupancyStatus
                : $root.transit_realtime.VehiclePosition.OccupancyStatus[message.departureOccupancyStatus]
              : message.departureOccupancyStatus;
        return object;
      };
      ...
      StopTimeUpdate.StopTimeProperties = (function () {
        ...
        StopTimeProperties.encode = function encode(message, writer) {
          if (!writer) writer = $Writer.create();
          if (message.assignedStopId != null && Object.hasOwnProperty.call(message, 'assignedStopId')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.assignedStopId);
          return writer;
        };
        ...
        StopTimeProperties.verify = function verify(message) {
          if (typeof message !== 'object' || message === null) return 'object expected';
          if (message.assignedStopId != null && message.hasOwnProperty('assignedStopId')) if (!$util.isString(message.assignedStopId)) return 'assignedStopId: string expected';
          return null;
        };
        ...
        StopTimeProperties.fromObject = function fromObject(object) {
          if (object instanceof $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties) return object;
        ...
        StopTimeProperties.toObject = function toObject(message, options) {
          ...
          if (message.assignedStopId != null && message.hasOwnProperty('assignedStopId')) object.assignedStopId = message.assignedStopId;
          return object;
        };
    ...
    TripUpdate.TripProperties = (function () {
      ...
      TripProperties.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.tripId != null && Object.hasOwnProperty.call(message, 'tripId')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.tripId);
        if (message.startDate != null && Object.hasOwnProperty.call(message, 'startDate')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.startDate);
        if (message.startTime != null && Object.hasOwnProperty.call(message, 'startTime')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.startTime);
        if (message.shapeId != null && Object.hasOwnProperty.call(message, 'shapeId')) writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.shapeId);
        return writer;
      };
      ...
      TripProperties.verify = function verify(message) {
        ...
        if (message.shapeId != null && message.hasOwnProperty('shapeId')) if (!$util.isString(message.shapeId)) return 'shapeId: string expected';
        return null;
      };
      ...
      TripProperties.toObject = function toObject(message, options) {
        ...
        if (message.shapeId != null && message.hasOwnProperty('shapeId')) object.shapeId = message.shapeId;
        return object;
      };
  ...
  transit_realtime.VehiclePosition = (function () {
    ...
    VehiclePosition.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.trip != null && Object.hasOwnProperty.call(message, 'trip')) $root.transit_realtime.TripDescriptor.encode(message.trip, writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
      if (message.position != null && Object.hasOwnProperty.call(message, 'position')) $root.transit_realtime.Position.encode(message.position, writer.uint32(/* id 2, wireType 2 =*/ 18).fork()).ldelim();
      if (message.currentStopSequence != null && Object.hasOwnProperty.call(message, 'currentStopSequence')) writer.uint32(/* id 3, wireType 0 =*/ 24).uint32(message.currentStopSequence);
      if (message.currentStatus != null && Object.hasOwnProperty.call(message, 'currentStatus')) writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.currentStatus);
      if (message.timestamp != null && Object.hasOwnProperty.call(message, 'timestamp')) writer.uint32(/* id 5, wireType 0 =*/ 40).uint64(message.timestamp);
      if (message.congestionLevel != null && Object.hasOwnProperty.call(message, 'congestionLevel')) writer.uint32(/* id 6, wireType 0 =*/ 48).int32(message.congestionLevel);
      if (message.stopId != null && Object.hasOwnProperty.call(message, 'stopId')) writer.uint32(/* id 7, wireType 2 =*/ 58).string(message.stopId);
      if (message.vehicle != null && Object.hasOwnProperty.call(message, 'vehicle')) $root.transit_realtime.VehicleDescriptor.encode(message.vehicle, writer.uint32(/* id 8, wireType 2 =*/ 66).fork()).ldelim();
      if (message.occupancyStatus != null && Object.hasOwnProperty.call(message, 'occupancyStatus')) writer.uint32(/* id 9, wireType 0 =*/ 72).int32(message.occupancyStatus);
      if (message.occupancyPercentage != null && Object.hasOwnProperty.call(message, 'occupancyPercentage')) writer.uint32(/* id 10, wireType 0 =*/ 80).uint32(message.occupancyPercentage);
      if (message.multiCarriageDetails != null && message.multiCarriageDetails.length)
        for (var i = 0; i < message.multiCarriageDetails.length; ++i) $root.transit_realtime.VehiclePosition.CarriageDetails.encode(message.multiCarriageDetails[i], writer.uint32(/* id 11, wireType 2 =*/ 90).fork()).ldelim();
      return writer;
    };
    ...
    VehiclePosition.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 11: {
            if (!(message.multiCarriageDetails && message.multiCarriageDetails.length)) message.multiCarriageDetails = [];
    ...
    VehiclePosition.verify = function verify(message) {
      ...
      if (message.occupancyPercentage != null && message.hasOwnProperty('occupancyPercentage')) if (!$util.isInteger(message.occupancyPercentage)) return 'occupancyPercentage: integer expected';
      if (message.multiCarriageDetails != null && message.hasOwnProperty('multiCarriageDetails')) {
        if (!Array.isArray(message.multiCarriageDetails)) return 'multiCarriageDetails: array expected';
    ...
    VehiclePosition.fromObject = function fromObject(object) {
      ...
      if (object.trip != null) {
        if (typeof object.trip !== 'object') throw TypeError('.transit_realtime.VehiclePosition.trip: object expected');
        message.trip = $root.transit_realtime.TripDescriptor.fromObject(object.trip);
      }
      if (object.vehicle != null) {
        if (typeof object.vehicle !== 'object') throw TypeError('.transit_realtime.VehiclePosition.vehicle: object expected');
        message.vehicle = $root.transit_realtime.VehicleDescriptor.fromObject(object.vehicle);
      }
      if (object.position != null) {
        if (typeof object.position !== 'object') throw TypeError('.transit_realtime.VehiclePosition.position: object expected');
      ...
      if (object.occupancyPercentage != null) message.occupancyPercentage = object.occupancyPercentage >>> 0;
      if (object.multiCarriageDetails) {
        if (!Array.isArray(object.multiCarriageDetails)) throw TypeError('.transit_realtime.VehiclePosition.multiCarriageDetails: array expected');
        message.multiCarriageDetails = [];
        for (var i = 0; i < object.multiCarriageDetails.length; ++i) {
          if (typeof object.multiCarriageDetails[i] !== 'object') throw TypeError('.transit_realtime.VehiclePosition.multiCarriageDetails: object expected');
    ...
    VehiclePosition.toObject = function toObject(message, options) {
      ...
      if (message.currentStatus != null && message.hasOwnProperty('currentStatus'))
        object.currentStatus =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.VehicleStopStatus[message.currentStatus] === undefined
      ...
      if (message.congestionLevel != null && message.hasOwnProperty('congestionLevel'))
        object.congestionLevel =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.CongestionLevel[message.congestionLevel] === undefined
      ...
      if (message.occupancyStatus != null && message.hasOwnProperty('occupancyStatus'))
        object.occupancyStatus =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.OccupancyStatus[message.occupancyStatus] === undefined
              ? message.occupancyStatus
              : $root.transit_realtime.VehiclePosition.OccupancyStatus[message.occupancyStatus]
            : message.occupancyStatus;
      if (message.occupancyPercentage != null && message.hasOwnProperty('occupancyPercentage')) object.occupancyPercentage = message.occupancyPercentage;
      if (message.multiCarriageDetails && message.multiCarriageDetails.length) {
        object.multiCarriageDetails = [];
        for (var j = 0; j < message.multiCarriageDetails.length; ++j) object.multiCarriageDetails[j] = $root.transit_realtime.VehiclePosition.CarriageDetails.toObject(message.multiCarriageDetails[j], options);
      }
      return object;
    };
    ...
    VehiclePosition.CarriageDetails = (function () {
      ...
      CarriageDetails.encode = function encode(message, writer) {
        ...
        if (message.occupancyStatus != null && Object.hasOwnProperty.call(message, 'occupancyStatus')) writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.occupancyStatus);
        if (message.occupancyPercentage != null && Object.hasOwnProperty.call(message, 'occupancyPercentage')) writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.occupancyPercentage);
        if (message.carriageSequence != null && Object.hasOwnProperty.call(message, 'carriageSequence')) writer.uint32(/* id 5, wireType 0 =*/ 40).uint32(message.carriageSequence);
        return writer;
      };
      ...
      CarriageDetails.verify = function verify(message) {
        ...
        if (message.occupancyPercentage != null && message.hasOwnProperty('occupancyPercentage')) if (!$util.isInteger(message.occupancyPercentage)) return 'occupancyPercentage: integer expected';
        if (message.carriageSequence != null && message.hasOwnProperty('carriageSequence')) if (!$util.isInteger(message.carriageSequence)) return 'carriageSequence: integer expected';
        return null;
      };
      ...
      CarriageDetails.fromObject = function fromObject(object) {
        ...
        if (object.occupancyPercentage != null) message.occupancyPercentage = object.occupancyPercentage | 0;
        if (object.carriageSequence != null) message.carriageSequence = object.carriageSequence >>> 0;
        return message;
      };
        ...
        if (message.occupancyStatus != null && message.hasOwnProperty('occupancyStatus'))
          object.occupancyStatus =
            options.enums === String
              ...
              : message.occupancyStatus;
        if (message.occupancyPercentage != null && message.hasOwnProperty('occupancyPercentage')) object.occupancyPercentage = message.occupancyPercentage;
        if (message.carriageSequence != null && message.hasOwnProperty('carriageSequence')) object.carriageSequence = message.carriageSequence;
        return object;
      };
  ...
  transit_realtime.Alert = (function () {
    ...
    Alert.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.activePeriod != null && message.activePeriod.length) for (var i = 0; i < message.activePeriod.length; ++i) $root.transit_realtime.TimeRange.encode(message.activePeriod[i], writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
      if (message.informedEntity != null && message.informedEntity.length)
        for (var i = 0; i < message.informedEntity.length; ++i) $root.transit_realtime.EntitySelector.encode(message.informedEntity[i], writer.uint32(/* id 5, wireType 2 =*/ 42).fork()).ldelim();
      if (message.cause != null && Object.hasOwnProperty.call(message, 'cause')) writer.uint32(/* id 6, wireType 0 =*/ 48).int32(message.cause);
      if (message.effect != null && Object.hasOwnProperty.call(message, 'effect')) writer.uint32(/* id 7, wireType 0 =*/ 56).int32(message.effect);
      if (message.url != null && Object.hasOwnProperty.call(message, 'url')) $root.transit_realtime.TranslatedString.encode(message.url, writer.uint32(/* id 8, wireType 2 =*/ 66).fork()).ldelim();
      if (message.headerText != null && Object.hasOwnProperty.call(message, 'headerText')) $root.transit_realtime.TranslatedString.encode(message.headerText, writer.uint32(/* id 10, wireType 2 =*/ 82).fork()).ldelim();
      if (message.descriptionText != null && Object.hasOwnProperty.call(message, 'descriptionText')) $root.transit_realtime.TranslatedString.encode(message.descriptionText, writer.uint32(/* id 11, wireType 2 =*/ 90).fork()).ldelim();
      if (message.ttsHeaderText != null && Object.hasOwnProperty.call(message, 'ttsHeaderText')) $root.transit_realtime.TranslatedString.encode(message.ttsHeaderText, writer.uint32(/* id 12, wireType 2 =*/ 98).fork()).ldelim();
      if (message.ttsDescriptionText != null && Object.hasOwnProperty.call(message, 'ttsDescriptionText')) $root.transit_realtime.TranslatedString.encode(message.ttsDescriptionText, writer.uint32(/* id 13, wireType 2 =*/ 106).fork()).ldelim();
      if (message.severityLevel != null && Object.hasOwnProperty.call(message, 'severityLevel')) writer.uint32(/* id 14, wireType 0 =*/ 112).int32(message.severityLevel);
      if (message.image != null && Object.hasOwnProperty.call(message, 'image')) $root.transit_realtime.TranslatedImage.encode(message.image, writer.uint32(/* id 15, wireType 2 =*/ 122).fork()).ldelim();
      if (message.imageAlternativeText != null && Object.hasOwnProperty.call(message, 'imageAlternativeText')) $root.transit_realtime.TranslatedString.encode(message.imageAlternativeText, writer.uint32(/* id 16, wireType 2 =*/ 130).fork()).ldelim();
      if (message.causeDetail != null && Object.hasOwnProperty.call(message, 'causeDetail')) $root.transit_realtime.TranslatedString.encode(message.causeDetail, writer.uint32(/* id 17, wireType 2 =*/ 138).fork()).ldelim();
      if (message.effectDetail != null && Object.hasOwnProperty.call(message, 'effectDetail')) $root.transit_realtime.TranslatedString.encode(message.effectDetail, writer.uint32(/* id 18, wireType 2 =*/ 146).fork()).ldelim();
      return writer;
    };
    ...
    Alert.fromObject = function fromObject(object) {
      ...
      if (object.activePeriod) {
        ...
        for (var i = 0; i < object.activePeriod.length; ++i) {
          if (typeof object.activePeriod[i] !== 'object') throw TypeError('.transit_realtime.Alert.activePeriod: object expected');
      ...
      if (object.informedEntity) {
        ...
        for (var i = 0; i < object.informedEntity.length; ++i) {
          if (typeof object.informedEntity[i] !== 'object') throw TypeError('.transit_realtime.Alert.informedEntity: object expected');
      ...
      if (object.url != null) {
        if (typeof object.url !== 'object') throw TypeError('.transit_realtime.Alert.url: object expected');
        message.url = $root.transit_realtime.TranslatedString.fromObject(object.url);
      }
      if (object.headerText != null) {
        if (typeof object.headerText !== 'object') throw TypeError('.transit_realtime.Alert.headerText: object expected');
        message.headerText = $root.transit_realtime.TranslatedString.fromObject(object.headerText);
      }
      if (object.descriptionText != null) {
        if (typeof object.descriptionText !== 'object') throw TypeError('.transit_realtime.Alert.descriptionText: object expected');
      ...
      if (object.ttsHeaderText != null) {
        if (typeof object.ttsHeaderText !== 'object') throw TypeError('.transit_realtime.Alert.ttsHeaderText: object expected');
      ...
      if (object.ttsDescriptionText != null) {
        if (typeof object.ttsDescriptionText !== 'object') throw TypeError('.transit_realtime.Alert.ttsDescriptionText: object expected');
      ...
      if (object.image != null) {
        if (typeof object.image !== 'object') throw TypeError('.transit_realtime.Alert.image: object expected');
        message.image = $root.transit_realtime.TranslatedImage.fromObject(object.image);
      }
      if (object.imageAlternativeText != null) {
        if (typeof object.imageAlternativeText !== 'object') throw TypeError('.transit_realtime.Alert.imageAlternativeText: object expected');
      ...
      if (object.causeDetail != null) {
        if (typeof object.causeDetail !== 'object') throw TypeError('.transit_realtime.Alert.causeDetail: object expected');
        message.causeDetail = $root.transit_realtime.TranslatedString.fromObject(object.causeDetail);
      }
      if (object.effectDetail != null) {
        if (typeof object.effectDetail !== 'object') throw TypeError('.transit_realtime.Alert.effectDetail: object expected');
    ...
    Alert.toObject = function toObject(message, options) {
      ...
      if (message.activePeriod && message.activePeriod.length) {
        object.activePeriod = [];
        for (var j = 0; j < message.activePeriod.length; ++j) object.activePeriod[j] = $root.transit_realtime.TimeRange.toObject(message.activePeriod[j], options);
      }
      if (message.informedEntity && message.informedEntity.length) {
        object.informedEntity = [];
        for (var j = 0; j < message.informedEntity.length; ++j) object.informedEntity[j] = $root.transit_realtime.EntitySelector.toObject(message.informedEntity[j], options);
      }
      if (message.cause != null && message.hasOwnProperty('cause'))
      ...
      if (message.ttsHeaderText != null && message.hasOwnProperty('ttsHeaderText')) object.ttsHeaderText = $root.transit_realtime.TranslatedString.toObject(message.ttsHeaderText, options);
      if (message.ttsDescriptionText != null && message.hasOwnProperty('ttsDescriptionText')) object.ttsDescriptionText = $root.transit_realtime.TranslatedString.toObject(message.ttsDescriptionText, options);
      if (message.severityLevel != null && message.hasOwnProperty('severityLevel'))
        object.severityLevel =
          options.enums === String ? ($root.transit_realtime.Alert.SeverityLevel[message.severityLevel] === undefined ? message.severityLevel : $root.transit_realtime.Alert.SeverityLevel[message.severityLevel]) : message.severityLevel;
      if (message.image != null && message.hasOwnProperty('image')) object.image = $root.transit_realtime.TranslatedImage.toObject(message.image, options);
      if (message.imageAlternativeText != null && message.hasOwnProperty('imageAlternativeText')) object.imageAlternativeText = $root.transit_realtime.TranslatedString.toObject(message.imageAlternativeText, options);
      if (message.causeDetail != null && message.hasOwnProperty('causeDetail')) object.causeDetail = $root.transit_realtime.TranslatedString.toObject(message.causeDetail, options);
      if (message.effectDetail != null && message.hasOwnProperty('effectDetail')) object.effectDetail = $root.transit_realtime.TranslatedString.toObject(message.effectDetail, options);
      return object;
    };
  ...
  transit_realtime.TimeRange = (function () {
    ...
    TimeRange.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.start != null && Object.hasOwnProperty.call(message, 'start')) writer.uint32(/* id 1, wireType 0 =*/ 8).uint64(message.start);
      if (message.end != null && Object.hasOwnProperty.call(message, 'end')) writer.uint32(/* id 2, wireType 0 =*/ 16).uint64(message.end);
      return writer;
    };
    ...
    TimeRange.fromObject = function fromObject(object) {
      ...
      if (object.start != null)
        ...
        else if (typeof object.start === 'object') message.start = new $util.LongBits(object.start.low >>> 0, object.start.high >>> 0).toNumber(true);
      if (object.end != null)
        ...
        else if (typeof object.end === 'object') message.end = new $util.LongBits(object.end.low >>> 0, object.end.high >>> 0).toNumber(true);
      return message;
    };
    ...
    TimeRange.toObject = function toObject(message, options) {
      ...
      if (message.start != null && message.hasOwnProperty('start'))
        if (typeof message.start === 'number') object.start = options.longs === String ? String(message.start) : message.start;
        else object.start = options.longs === String ? $util.Long.prototype.toString.call(message.start) : options.longs === Number ? new $util.LongBits(message.start.low >>> 0, message.start.high >>> 0).toNumber(true) : message.start;
      if (message.end != null && message.hasOwnProperty('end'))
        if (typeof message.end === 'number') object.end = options.longs === String ? String(message.end) : message.end;
        else object.end = options.longs === String ? $util.Long.prototype.toString.call(message.end) : options.longs === Number ? new $util.LongBits(message.end.low >>> 0, message.end.high >>> 0).toNumber(true) : message.end;
      return object;
    };
  ...
  transit_realtime.Position = (function () {
    ...
    Position.encode = function encode(message, writer) {
      ...
      if (message.bearing != null && Object.hasOwnProperty.call(message, 'bearing')) writer.uint32(/* id 3, wireType 5 =*/ 29).float(message.bearing);
      if (message.odometer != null && Object.hasOwnProperty.call(message, 'odometer')) writer.uint32(/* id 4, wireType 1 =*/ 33).double(message.odometer);
      if (message.speed != null && Object.hasOwnProperty.call(message, 'speed')) writer.uint32(/* id 5, wireType 5 =*/ 45).float(message.speed);
      return writer;
    };
    ...
    Position.toObject = function toObject(message, options) {
      ...
      if (message.bearing != null && message.hasOwnProperty('bearing')) object.bearing = options.json && !isFinite(message.bearing) ? String(message.bearing) : message.bearing;
      if (message.odometer != null && message.hasOwnProperty('odometer')) object.odometer = options.json && !isFinite(message.odometer) ? String(message.odometer) : message.odometer;
      if (message.speed != null && message.hasOwnProperty('speed')) object.speed = options.json && !isFinite(message.speed) ? String(message.speed) : message.speed;
      return object;
    };
  ...
  transit_realtime.TripDescriptor = (function () {
    ...
    TripDescriptor.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.tripId != null && Object.hasOwnProperty.call(message, 'tripId')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.tripId);
      if (message.startTime != null && Object.hasOwnProperty.call(message, 'startTime')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.startTime);
      if (message.startDate != null && Object.hasOwnProperty.call(message, 'startDate')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.startDate);
      if (message.scheduleRelationship != null && Object.hasOwnProperty.call(message, 'scheduleRelationship')) writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.scheduleRelationship);
      if (message.routeId != null && Object.hasOwnProperty.call(message, 'routeId')) writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.routeId);
      if (message.directionId != null && Object.hasOwnProperty.call(message, 'directionId')) writer.uint32(/* id 6, wireType 0 =*/ 48).uint32(message.directionId);
      return writer;
    };
    ...
    TripDescriptor.toObject = function toObject(message, options) {
      ...
      if (message.scheduleRelationship != null && message.hasOwnProperty('scheduleRelationship'))
        object.scheduleRelationship =
          options.enums === String
            ? $root.transit_realtime.TripDescriptor.ScheduleRelationship[message.scheduleRelationship] === undefined
              ? message.scheduleRelationship
              : $root.transit_realtime.TripDescriptor.ScheduleRelationship[message.scheduleRelationship]
            : message.scheduleRelationship;
  ...
  transit_realtime.VehicleDescriptor = (function () {
    ...
    VehicleDescriptor.encode = function encode(message, writer) {
      ...
      if (message.id != null && Object.hasOwnProperty.call(message, 'id')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.id);
      if (message.label != null && Object.hasOwnProperty.call(message, 'label')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.label);
      if (message.licensePlate != null && Object.hasOwnProperty.call(message, 'licensePlate')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.licensePlate);
      if (message.wheelchairAccessible != null && Object.hasOwnProperty.call(message, 'wheelchairAccessible')) writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.wheelchairAccessible);
      return writer;
    };
    ...
    VehicleDescriptor.toObject = function toObject(message, options) {
      ...
      if (message.wheelchairAccessible != null && message.hasOwnProperty('wheelchairAccessible'))
        object.wheelchairAccessible =
          options.enums === String
            ? $root.transit_realtime.VehicleDescriptor.WheelchairAccessible[message.wheelchairAccessible] === undefined
              ? message.wheelchairAccessible
              : $root.transit_realtime.VehicleDescriptor.WheelchairAccessible[message.wheelchairAccessible]
            : message.wheelchairAccessible;
      return object;
    };
  ...
  transit_realtime.EntitySelector = (function () {
    ...
    EntitySelector.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.agencyId != null && Object.hasOwnProperty.call(message, 'agencyId')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.agencyId);
      if (message.routeId != null && Object.hasOwnProperty.call(message, 'routeId')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.routeId);
      if (message.routeType != null && Object.hasOwnProperty.call(message, 'routeType')) writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.routeType);
      if (message.trip != null && Object.hasOwnProperty.call(message, 'trip')) $root.transit_realtime.TripDescriptor.encode(message.trip, writer.uint32(/* id 4, wireType 2 =*/ 34).fork()).ldelim();
      if (message.stopId != null && Object.hasOwnProperty.call(message, 'stopId')) writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.stopId);
      if (message.directionId != null && Object.hasOwnProperty.call(message, 'directionId')) writer.uint32(/* id 6, wireType 0 =*/ 48).uint32(message.directionId);
      return writer;
    };
    ...
    EntitySelector.fromObject = function fromObject(object) {
      ...
      if (object.trip != null) {
        if (typeof object.trip !== 'object') throw TypeError('.transit_realtime.EntitySelector.trip: object expected');
        message.trip = $root.transit_realtime.TripDescriptor.fromObject(object.trip);
      }
      if (object.stopId != null) message.stopId = String(object.stopId);
      if (object.directionId != null) message.directionId = object.directionId >>> 0;
  ...
  transit_realtime.TranslatedString = (function () {
    ...
    TranslatedString.encode = function encode(message, writer) {
      ...
      if (message.translation != null && message.translation.length)
        for (var i = 0; i < message.translation.length; ++i) $root.transit_realtime.TranslatedString.Translation.encode(message.translation[i], writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
      return writer;
    };
    ...
    TranslatedString.fromObject = function fromObject(object) {
      ...
      if (object.translation) {
        ...
        for (var i = 0; i < object.translation.length; ++i) {
          if (typeof object.translation[i] !== 'object') throw TypeError('.transit_realtime.TranslatedString.translation: object expected');
    ...
    TranslatedString.toObject = function toObject(message, options) {
      ...
      if (message.translation && message.translation.length) {
        object.translation = [];
        for (var j = 0; j < message.translation.length; ++j) object.translation[j] = $root.transit_realtime.TranslatedString.Translation.toObject(message.translation[j], options);
      }
      return object;
    };
    ...
    TranslatedString.Translation = (function () {
      ...
      Translation.encode = function encode(message, writer) {
        ...
        if (message.language != null && Object.hasOwnProperty.call(message, 'language')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.language);
        return writer;
      };
  ...
  transit_realtime.TranslatedImage = (function () {
    ...
    TranslatedImage.encode = function encode(message, writer) {
      ...
      if (message.localizedImage != null && message.localizedImage.length)
        for (var i = 0; i < message.localizedImage.length; ++i) $root.transit_realtime.TranslatedImage.LocalizedImage.encode(message.localizedImage[i], writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
      return writer;
    };
    ...
    TranslatedImage.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.localizedImage && message.localizedImage.length)) message.localizedImage = [];
    ...
    TranslatedImage.verify = function verify(message) {
      ...
      if (message.localizedImage != null && message.hasOwnProperty('localizedImage')) {
        if (!Array.isArray(message.localizedImage)) return 'localizedImage: array expected';
    ...
    TranslatedImage.fromObject = function fromObject(object) {
      if (object instanceof $root.transit_realtime.TranslatedImage) return object;
      var message = new $root.transit_realtime.TranslatedImage();
      if (object.localizedImage) {
        if (!Array.isArray(object.localizedImage)) throw TypeError('.transit_realtime.TranslatedImage.localizedImage: array expected');
        message.localizedImage = [];
        for (var i = 0; i < object.localizedImage.length; ++i) {
          if (typeof object.localizedImage[i] !== 'object') throw TypeError('.transit_realtime.TranslatedImage.localizedImage: object expected');
    ...
    TranslatedImage.toObject = function toObject(message, options) {
      ...
      if (message.localizedImage && message.localizedImage.length) {
        ...
        for (var j = 0; j < message.localizedImage.length; ++j) object.localizedImage[j] = $root.transit_realtime.TranslatedImage.LocalizedImage.toObject(message.localizedImage[j], options);
      }
      return object;
    };
    ...
    TranslatedImage.LocalizedImage = (function () {
      ...
      LocalizedImage.encode = function encode(message, writer) {
        ...
        if (message.language != null && Object.hasOwnProperty.call(message, 'language')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.language);
        return writer;
      };
      ...
      LocalizedImage.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty('url')) throw $util.ProtocolError("missing required 'url'", { instance: message });
        if (!message.hasOwnProperty('mediaType')) throw $util.ProtocolError("missing required 'mediaType'", { instance: message });
        return message;
      };
      ...
      LocalizedImage.verify = function verify(message) {
        ...
        if (!$util.isString(message.mediaType)) return 'mediaType: string expected';
        if (message.language != null && message.hasOwnProperty('language')) if (!$util.isString(message.language)) return 'language: string expected';
        return null;
      };
      ...
      LocalizedImage.fromObject = function fromObject(object) {
        if (object instanceof $root.transit_realtime.TranslatedImage.LocalizedImage) return object;
        var message = new $root.transit_realtime.TranslatedImage.LocalizedImage();
        if (object.url != null) message.url = String(object.url);
        if (object.mediaType != null) message.mediaType = String(object.mediaType);
        if (object.language != null) message.language = String(object.language);
        return message;
      };
      ...
      LocalizedImage.toObject = function toObject(message, options) {
        ...
        if (message.mediaType != null && message.hasOwnProperty('mediaType')) object.mediaType = message.mediaType;
        if (message.language != null && message.hasOwnProperty('language')) object.language = message.language;
        return object;
      };
  ...
  transit_realtime.Shape = (function () {
    ...
    Shape.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.shapeId != null && Object.hasOwnProperty.call(message, 'shapeId')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.shapeId);
      if (message.encodedPolyline != null && Object.hasOwnProperty.call(message, 'encodedPolyline')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.encodedPolyline);
      return writer;
    };
    ...
    Shape.verify = function verify(message) {
      if (typeof message !== 'object' || message === null) return 'object expected';
      if (message.shapeId != null && message.hasOwnProperty('shapeId')) if (!$util.isString(message.shapeId)) return 'shapeId: string expected';
      if (message.encodedPolyline != null && message.hasOwnProperty('encodedPolyline')) if (!$util.isString(message.encodedPolyline)) return 'encodedPolyline: string expected';
      return null;
    };
    ...
    Shape.fromObject = function fromObject(object) {
      ...
      if (object.shapeId != null) message.shapeId = String(object.shapeId);
      if (object.encodedPolyline != null) message.encodedPolyline = String(object.encodedPolyline);
      return message;
    };
    ...
    Shape.toObject = function toObject(message, options) {
      ...
      if (message.shapeId != null && message.hasOwnProperty('shapeId')) object.shapeId = message.shapeId;
      if (message.encodedPolyline != null && message.hasOwnProperty('encodedPolyline')) object.encodedPolyline = message.encodedPolyline;
      return object;
    };
