...
module.exports = async () => {
  ...
  const allDirectoryFiles = fs.readdirSync(`${settings.BASE_DIR}/demand/date-line-stop`, { encoding: 'utf-8' });

  console.log(allDirectoryFiles);
  return;

  // 2.
  // Open file from cloned repository
  console.log(`⤷ Open data file...`);
  const allEncmRaw = fs.readFileSync(`${settings.BASE_DIR}/demand/encm/encm.csv`, { encoding: 'utf-8' });
