...
module.exports = async () => {
  ...
  const allItemsRaw = fs.readFileSync(`${settings.BASE_DIR}/connections/light_rail_stations/light_rail_stations.csv`, { encoding: 'utf-8' });
  ...
  for await (const key of SERVERDB.client.scanIterator({ TYPE: 'string', MATCH: 'datasets/connections/light_rail_stations/*' })) {
